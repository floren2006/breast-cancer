...
with insight_tabs[3]:
    ...
    # --- Boxplot texture_mean sebagai pelengkap (DIPERBAIKI) ---
    st.subheader("Distribusi texture_mean per Kelas")

    # Siapkan data untuk boxplot
    data_box = [benign["texture_mean"].values, malignant["texture_mean"].values]
    labels_box = ["Benign", "Malignant"]

    fig2, ax2 = plt.subplots(figsize=(10, 5))

    # Buat boxplot dengan posisi manual
    box = ax2.boxplot(data_box, positions=[1, 2], patch_artist=True, notch=True)
